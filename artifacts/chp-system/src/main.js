...
import { loadSettings, saveSettings, deleteFacility, addFacility, exportJSON, importJSON, adminUserWizard, iamApproveUser, iamRejectUser, iamSuspendUser, iamReactivateUser, iamDeactivateUser, iamAssignFacility, iamChangeRole, inviteStaff } from './pages/settings.js';
...
export function printPage(id) {
  const tabIndex = {
    dashboard: 0, new_referral: 1, my_referrals: 2, tracker: 3,
    directory: 3, report: 4, group: 5, settings: 6,
  };
